...
Фудграм позволяет обмениваться рецептами, создавать новые рецепты блюд, фолловить других пользователей для просмотра их рецептов и дает бесплатную возможность скачать корзину понравившихся рецептов.
# Технологии #
